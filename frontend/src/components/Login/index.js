...
const Login = (props) => {
    ...
    const login = async (e) => {
        ...
        try {
            const response = await fetch('https://react-crud-iszo.onrender.com/api/user/login', options);
    ...
    const register = async (e) => {
        ...
        try {
            const response = await fetch('https://react-crud-iszo.onrender.com/api/user/register', options);
            const data = await response.json();
            console.log(data);
        } catch (error) {
            console.error('An error occurred:', error);
